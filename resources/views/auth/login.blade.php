...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div class="flex flex-col items-center justify-center px-6 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        <a href="#" class="flex items-center justify-center mb-8 text-2xl font-semibold lg:mb-10 dark:text-white">
            <img src="https://cdn-icons-png.flaticon.com/512/3687/3687416.png" class="mr-4 h-11 rounded-full" alt="Logo">
            <span>Digital Gallery Management System</span>
        </a>
        <!-- Card -->
        <div class="w-full max-w-lg p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <form class="mt-8 space-y-6" action="/login" method="POST">
                ...
                <div class="text-white bg-danger-600 p-4 rounded-lg" role="alert">
                    {{ $message }}
                </div>
                @endif
                @if ($message = Session::get('success'))
                <div class="text-white bg-success-600 p-4 rounded-lg" role="alert">
                    {{ $message }}
                </div>
                @endif
                <div>
                ...
                {{-- <div class="flex items-start">
                    <a href="#" class="text-sm text-primary-700 hover:underline dark:text-primary-500">Forgot Password?</a>
                </div> --}}
                <button type="submit" class="w-full px-5 py-3 text-base font-medium text-center text-white bg-primary-600 rounded-lg hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login</button>
